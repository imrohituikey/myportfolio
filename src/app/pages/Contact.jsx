    ...
    >
      <div className="flex flex-col gap-8 xl:gap-12 items-center w-full h-full">
        ...
        <div className=" flex flex-col gap-4 xl:gap-6 w-full text-center items-center">
          ...
          <form className=" flex flex-col gap-6 xl:w-[60%] p-3 xl:p-8 rounded-md">
          ...
          <button className="link px-3 py-1 xl:px-8 xl:py-2 bg-purple-400 text-black rounded-md text-sm">
            Submit
          </button>
